...
SETTING_SPECS = {
    ...
    "eps_radio": SettingSpec("eps", _float_choice(C.EPSS), C.DEFAULT_EPS),
    "method_radio": SettingSpec("method", _choice(C.METHODS), C.DEFAULT_METHOD),
    "budget_radio": SettingSpec("budget", _float_choice(C.BUDGETS), C.DEFAULT_BUDGET),
    "variant_radio": SettingSpec("variant", _choice(C.VARIANTS), C.DEFAULT_VARIANT),
}
PRESET_KEYS = {"net": "net_select", "k": "k_slider", "p": "p_slider", "d": "d_slider", "s": "s_slider", "density": "density_slider", "spread": "spread_slider", "load": "load_slider",
               ...
               "eps": "eps_radio", "method": "method_radio", "budget": "budget_radio", "variant": "variant_radio"}
