...
Die Einzelgut-Verfahren (allein, nacheinander, Entkopplung) nutzen Successive Shortest Paths (`gk_ssp.py`, Kopie der SSP-Demo): ein Gut ist ein gewöhnlicher Min-Cost-Flow;
